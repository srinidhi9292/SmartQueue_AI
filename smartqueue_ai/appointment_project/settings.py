...
# Set EMAIL_BACKEND to smtp and fill in credentials via env vars for production
# ---------------------------------------------------------------------------
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@smartqueue.ai')
